...
func (in *IPAMStatus) DeepEqual(other *IPAMStatus) bool {
	...
	if ((in.UsedPodCIDRs != nil) && (other.UsedPodCIDRs != nil)) || ((in.UsedPodCIDRs == nil) != (other.UsedPodCIDRs == nil)) {
		in, other := &in.UsedPodCIDRs, &other.UsedPodCIDRs
		if other == nil {
			return false
		}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *UsedPodCIDR) DeepEqual(other *UsedPodCIDR) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *UsedPodCIDRMap) DeepEqual(other *UsedPodCIDRMap) bool {
	if other == nil {
		return false
	}
